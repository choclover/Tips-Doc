package com.studentpaldaemon.app.receiver;
...
public class MyDeviceAdminReceiver extends DeviceAdminReceiver {
  private static final String TAG = "Daemon.DeviceAdminReceiver";
  ...
  public MyDeviceAdminReceiver(Activity context) throws Exception {
    if (context == null) {
      throw new Exception("Context param should NOT be NULL!");
    }
